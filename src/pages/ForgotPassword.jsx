                        ...
                        <form onSubmit={handleSubmit} className="flex flex-col w-[100%]">
                            {
                                !emailSent && (
                                    <label className="mt-3">
                                        <p className="font-semibold">Email Address <sup className="text-red-700">*</sup></p>
                                        <input
                                        type="email"
                                        name="email"
                                        value={email}
                                        ...
                                        className="w-[85%] text-[12px] p-2 bg-richblack-800 my-2 outline-none rounded-sm"
                                        />
                                    </label>
                                )
                            }
                            <button type="submit" className = "w-[85%] mt-4 rounded-[8px] bg-yellow-500 py-[8px] px-[12px] font-medium text-richblack-900">
                                {
